Feature: Progressive price billing
  ...
  Scenario Outline: Overuse charge for cdn_traf95_max
    ...
    Examples:
      ...
      | 2024-01-01 | 1 Gbps   | overuse,cdn_traf95_max 9.05 USD | 200*0.0065 + 100*0.0070 + 100*0.0075 + 100*0.0180 + 450*0.01 |
      | 2024-01-01 | 720 Mbps | overuse,cdn_traf95_max 7.19 USD | 0*0.0065 + 20*0.0070 + 100*0.0075 + 100*0.0180 + 450*0.01    |
